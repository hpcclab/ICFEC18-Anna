...
function [ret_val] = getConfiguration(argType)
    if(argType == 1)
        ret_val = 'D:Users/annakovalenko/Downloads/V2I-master/sim_results';
    elseif(argType == 2)
    ...
    elseif(argType == 11)
        ret_val = 50; %step size of mobile device count
    elseif(argType == 12)
        ret_val = 300; %max number of mobile device
    elseif(argType == 19)
